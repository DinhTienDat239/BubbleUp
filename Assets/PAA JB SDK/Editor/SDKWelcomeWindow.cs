...
public class SDKWelcomeWindow : EditorWindow
{
    ...
    {
        SDKWelcomeWindow window = GetWindow<SDKWelcomeWindow>(true, "PAA JB SDK", true);
    ...
    private void OnEnable()
    {
        logoTexture = AssetDatabase.LoadAssetAtPath<Texture2D>(
            "Assets/PAA JB SDK/Editor/logo_joybit.png"
        );
    }
    ...
    private void OnGUI()
    {
        ...
        GUILayout.BeginHorizontal();
        GUILayout.FlexibleSpace();
        GUILayout.Label("PAA JB SDK", titleStyle, GUILayout.ExpandWidth(true));
        GUILayout.FlexibleSpace();
        GUILayout.EndHorizontal();
        ...
        GUILayout.FlexibleSpace();
        GUILayout.Label(
            "SDK này được phát triển bởi lập trình viên Đinh Tiến Đạt và sự hỗ trợ từ công ty cổ phần JoyBit.\n\nVui lòng hiểu rằng đây là SDK vận hành nội bộ và đang được phát triển lâu dài.",
            introStyle,
            GUILayout.Width(360)
        );
        GUILayout.FlexibleSpace();
